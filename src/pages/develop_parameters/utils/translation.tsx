export function Translate(word: string) {
	if (word === "id")    return ""
	if (word === "update_by")    return ""
	if (word === "create_by")    return ""
	if (word === "multiplier")    return "倍率"
	if (word === "update_date")    return ""
	if (word === "create_date")    return ""
	if (word === "performance_level")    return ""
	if (word === "position")    return ""
	if (word === "position_type")    return ""
	...
	if (word === "end_date")    return ""
	if (word === "start_date")    return ""
	if (word === "sick_leave_dock")    return "病假扣薪"
	if (word === "personal_leave_dock")    return "事假扣薪"
	if (word === "rate_of_unpaid_leave")    return "rate_of_unpaid_leave"
