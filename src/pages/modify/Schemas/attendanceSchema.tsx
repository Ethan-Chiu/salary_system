...
export const attendanceSchema = (data: any, withEndDate?: boolean) => {
	const withEndDateSchema =  z.object({
		personal_leave_dock: z.coerce
			.number()
			.describe("personal_leave_dock")
			.default(data.personal_leave_dock),
		sick_leave_dock: z.coerce
			.number()
			.describe("sick_leave_dock")
		...
		end_date: data.end_date
			? z.coerce
					...
					.optional()
			: z.coerce.date().describe("end_date").optional(),
	});

	const withoutEndDateSchema =  z.object({
		personal_leave_dock: z.coerce
			.number()
			.describe("personal_leave_dock")
			.default(data.personal_leave_dock),
	...
	return (withEndDate)?withEndDateSchema:withoutEndDateSchema;
};
